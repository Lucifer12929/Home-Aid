          ...
          <div className="adminsetup">
            <div className="card" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  View all the workers who are registered for the triv joy
                  company
                </p>
                <button
                  type="button"
            ...
            <div className="card" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  View all the Shops who are registered for the triv joy company
                </p>
                <button
                  type="button"
                  className="btn btn-success"
            ...
            <div className="card" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  View all the Users who are signed up for the triv joy company
                </p>
                <button
                  type="button"
                  className="btn btn-success"
