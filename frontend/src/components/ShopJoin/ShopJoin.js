...
export default function ShopJoin() {
  ...
  var electImages = {
    image1:
      {eitem},
    image2:
      "https://e7.pngegg.com/pngimages/731/288/png-clipart-light-bulb-illustration-incandescent-light-bulb-lamp-electric-light-bulb-light-fixture-bulbs.png",
    image3:
                ...
                <div>
                  <p>
                    <a
                      ...
                      role="button"
                      aria-expanded="false"
                      aria-controls="trivitems"
                    >
                      {collapseTitle}
                    </a>
                  </p>

                  <div className="row" id="trivitems" height="">
                    <div className="col-sm-4">
                      <div className="form-group">
